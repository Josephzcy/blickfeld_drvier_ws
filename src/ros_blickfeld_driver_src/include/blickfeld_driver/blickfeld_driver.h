...
class BlickfeldDriver : public BlickfeldDriverCore {
 public:
   ...
   */
  void publishImuStaticTF(TransformMsgStampedPtr transform_msg_stamped) override;
 ...
 private:
   ...
   * @return true on success
   */
  bool publishImuStaticTFCallback(std_srvs::Empty::Request& service_request,
                                  std_srvs::Empty::Response& service_response);
